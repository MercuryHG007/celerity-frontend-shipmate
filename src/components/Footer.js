...
function Footer() {
    return (
        <div
            className='w-full flex justify-center relative left-0 bottom-0 bg-[#F8F9FD]'
        >
            <div
                className='absolute top-0 left-0'
            >
                <svg width="100%" height="143" viewBox="0 0 1440 130" fill="none" xmlns="http://www.w3.org/2000/svg">
